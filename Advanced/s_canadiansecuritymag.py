...
class canadianSecurityMagSpider(StaticCategoriesSpider):
    name = 's_canadiansecuritymag'
    allowed_domains = ["canadiansecuritymag.com"]
    start_urls = ['https://www.canadiansecuritymag.com/category/news']  
